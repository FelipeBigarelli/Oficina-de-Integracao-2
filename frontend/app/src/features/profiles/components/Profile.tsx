...
export function Profile() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6"> {/* Adjusted max-width and added padding */}
      <h1 className="text-4xl font-bold text-white mb-8">Meu Perfil</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"> {/* Added grid structure */}
        <div className="bg-gray-800 rounded-lg p-6 shadow-xl hover:shadow-2xl transition-shadow"> {/* Added container div */}
